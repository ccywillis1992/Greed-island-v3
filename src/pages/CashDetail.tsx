              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {entry.autoGenerated && (
                        <span
                          ...
                          title="Auto-generated entry linked to a Trade or Other Product record"
                        >
                          <Link className="w-3 h-3" />
                          <span>
                            {entry.linkedTradeId ? 'Auto (Trade)' : entry.linkedOtherProductId ? 'Auto (Other)' : 'Auto-Linked'}
                          </span>
                        </span>
                      )}
                  ...
                  <div className="flex items-center justify-between pt-1 border-t border-white/5">
                    ...
                    {/* Edit, Duplicate, and Delete Buttons (D2) */}
                      ...
                      {entry.autoGenerated ? (
                        <>
                          <button
                            ...
                            title="Auto-generated from Trade/Other Product — edit the underlying record to update this entry."
                          >
                          ...
                          <button
                            disabled
                            className="p-1.5 text-slate-600 cursor-not-allowed rounded-lg"
                            title="Auto-generated from Trade/Other Product — edit or delete the underlying record."
                          >
